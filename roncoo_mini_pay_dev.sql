...
Source Database       : roncoo_mini_pay_dev

Target Server Type    : MYSQL
Target Server Version : 50624
File Encoding         : 65001

Date: 2017-05-08 20:31:25
*/
...
-- ----------------------------
INSERT INTO `rp_account` VALUES ('b2a8d6c1ebac4060ba7a5ba9e43a41c5', '2017-05-06 16:37:57', '2017-05-06 16:37:57', '0', null, '99992017050610000001', '0.000000', '0.000000', '0.000000', 'ACTIVE', '0.000000', '0.000000', '0.000000', '0.000000', '0', '0.000000', '88882017050610001114');
...
-- ----------------------------
INSERT INTO `rp_pay_product` VALUES ('01c72326c971422d9aea7be90b9d474f', '2017-05-06 16:40:07', '2017-05-06 16:46:31', '0', 'ACTIVE', 'isee_pay_product', 'isee支付产品', 'YES');
...
-- ----------------------------
INSERT INTO `rp_pay_way` VALUES ('93231f1594904056b039e2d7ea48d69a', '0', '2017-05-06 16:41:33', null, 'ALIPAY', '支付宝', 'ALI_TEST', '支付宝测试', 'isee_pay_product', 'ACTIVE', null, '6');
...
CREATE TABLE `rp_user_info` (
  ...
  `pay_pwd` varchar(50) DEFAULT '123456' COMMENT '支付密码',
  PRIMARY KEY (`id`),
...
-- ----------------------------
INSERT INTO `rp_user_info` VALUES ('1', '2017-05-06 12:59:26', 'ACTIVE', '001', 'dinner', '13260916369', '13260916369', 'a3f0bec59cebeb60553ec80bbfd5dfdf', '123456');
INSERT INTO `rp_user_info` VALUES ('d07582daa4244531aa12010b9c625d76', '2017-05-06 16:37:57', 'ACTIVE', '88882017050610001114', 'zhuzhu', '99992017050610000001', '13260916369', 'e10adc3949ba59abbe56e057f20f883e', 'e10adc3949ba59abbe56e057f20f883e');
...
CREATE TABLE `rp_user_pay_config` (
  ...
  `security_rating` varchar(20) DEFAULT 'MD5' COMMENT '安全等级',
  `merchant_server_ip` varchar(200) DEFAULT NULL COMMENT '商户服务器IP',
  PRIMARY KEY (`id`)
...
INSERT INTO `seq_table` VALUES ('BANK_ORDER_NO_SEQ', '10000000', '1', '交易—-银行订单号');
INSERT INTO `seq_table` VALUES ('RECONCILIATION_BATCH_NO_SEQ', '10000000', '1', '对账—-批次号');
INSERT INTO `seq_table` VALUES ('TRX_NO_SEQ', '10000000', '1', '交易—-支付流水号');
